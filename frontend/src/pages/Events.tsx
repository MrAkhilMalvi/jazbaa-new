...
const events: Evt[] = [
  {
    ...
    format: "In-Person",
    status: "Upcoming",
    img: "https://images.unsplash.com/photo-1516280440614-37939bbacd81?auto=format&fit=crop&w=900&q=80",
  },
  {
    id: "2",
    title: "Acoustic Jam Circle",
    cat: "Music",
    date: "22",
    month: "May",
    day: "Thursday",
    ...
    format: "In-Person",
    status: "Upcoming",
    img: "https://images.unsplash.com/photo-1510915361894-db8b60106cb1?auto=format&fit=crop&w=900&q=80",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    format: "Online",
    status: "Past",
    img: "https://images.unsplash.com/photo-1504609813442-a8924e83f76e?auto=format&fit=crop&w=900&q=80",
  },
  {
    id: "6",
    title: "Open Mic: Storytelling Edition",
    cat: "Open Mic",
    date: "04",
    month: "Mar",
    day: "Tuesday",
    ...
    format: "In-Person",
    status: "Past",
    img: "https://images.unsplash.com/photo-1499415479124-43c32433a620?auto=format&fit=crop&w=900&q=80",
  },
  {
    id: "7",
    title: "Bollywood Dance Social",
    cat: "Dance",
    date: "28",
    month: "Feb",
    day: "Friday",
    ...
    format: "In-Person",
    status: "Past",
    img: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=900&q=80",
  },
];
                  ...
                  <div className="p-6 md:p-8 flex-grow flex flex-col">
                    <div className="flex gap-5 items-start">
                      ...
                      <div className="flex-grow pt-1">
                        <h3 className="font-bold text-xl md:text-xl text-slate-900 dark:text-white leading-tight mb-3 transition-colors duration-300">
                          {e.title}
                        </h3>
                        <div className="space-y-2 text-sm font-medium text-slate-600 dark:text-white/60 transition-colors duration-300">
                          <p className="flex items-center gap-2">
                            ...
                            {isPreview ? "DAY, TIME" : `${e.day}, ${e.time}`}
                          </p>
          ...
          {filteredEvents.length === 0 && (
            ...
            >
              ...
              <p className="text-slate-500 dark:text-white/50">
                Check back later for more exciting gatherings.
              </p>
            </motion.div>
          )}
        </div>
